    ...
    @Test
     void shouldCrateAFlashCardDeckAndReturnItAsCompatibleApkgString(){
        ...
        List<Flashcard> flashcards = List.of(
                new Flashcard("What is the capital of France?", "Paris. It is also the largest city in France and serves as the country's economic and cultural center."),
                new Flashcard("What is the capital of Germany?", "Berlin. It is the largest city in Germany and has a population of 3.7 million people.")
        );
